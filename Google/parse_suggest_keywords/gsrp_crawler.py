...
# ]
all_keyword_filepath = "3high_gsrp_keywords.json"
article_output_filepath = "3high_gsrp_articles.json"

# initial logging
# def init_logger(fuzzymatch_threshold):
#     logging.basicConfig(
#         filename=f"gen_company_daily_sentiment_{fuzzymatch_threshold}.log",
#         filemode="w",
...
#     lv2_kws = [item.text for item in soup.find("div", id="w3bYAd").find_all("a")]
...
#                     lv3_kws = [
#                         item.text
#                         for item in soup.find("div", id="w3bYAd").find_all("a")
#                     ]
